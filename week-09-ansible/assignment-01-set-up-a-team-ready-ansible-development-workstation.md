...
![Screenshot](screenshots/Ass1.Task3.ss3i.png)

![Screenshot](screenshots/Ass1.Task3.ss3ii.png)

![Screenshot](screenshots/Ass1.Task3.ss3iii.png)
...
![Screenshot](screenshots/Ass1.Task3.ss4.png)

![Screenshot](screenshots/Ass1.Task3.ss4i.png)
---
...
![Screenshot](screenshots/Ass1.Task4.ss5.png)
...
![Screenshot](screenshots/Ass1.Task4.ss6.png)
...
![Screenshot](screenshots/Ass1.Task5.ss7.png)
...
![Screenshot](screenshots/Ass1.Task6.ss8.png)
...
![Screenshot](screenshots/Ass1.Task7.ss9.png)
...
![Screenshot](screenshots/Ass1.Task7.ss10.png)
...
![Screenshot](screenshots/Ass1.Task8.ss11.png)
...
![Screenshot](screenshots/Ass1.Task8.ss12.png)

![Screenshot](screenshots/Ass1.Task8.ss12i.png)
...
One team-friendly feature is the project-level ansible.cfg and .editorconfig configuration. They keep important settings such as inventory location, Python interpreter, formatting, and Ansible behavior consistent for everyone working on the project.
---

**2. What is one pitfall you avoided while completing the setup?**

One pitfall I avoided was putting sensitive files and unnecessary files into Git. I made sure that the Python virtual environment and SSH private key were kept outside version control and were not staged in the project.
...
SSH private keys must remain outside version control because they are sensitive credentials that could allow unauthorized access if exposed. The .venv/ directory should also remain outside version control because it contains installed Python packages and environment-specific files that are unnecessary to share and can make the repository very large. Instead, dependencies should be defined in files such as requirements.txt so the environment can be recreated when needed.
